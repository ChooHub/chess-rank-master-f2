  ...
  return (
    <div className="space-y-6">
      {categories.map((category, index) => (
        <Card key={category.id} className="bg-gradient-card border-border/50 shadow-card animate-fade-in">
          <CardHeader>
              ...
              <div className="space-y-1">
                ...
                <CardDescription className="flex items-center gap-4">
                  ...
                  <span className="text-xs">
                    Priority {index + 1} • {category.filterColumn} {category.filterType} "{category.filterValue}"
                  </span>
                </CardDescription>
              </div>
